  ...
  return (
    <label className="flex items-center gap-1.5 text-xs text-gray-500 select-none">
      ...
      <select
        ...
        className="border border-gray-200 rounded px-1.5 py-0.5 text-xs bg-white text-gray-700 focus:outline-none focus:ring-1 focus:ring-blue-300 cursor-pointer"
      >
